    ...
    <div class="min-h-screen flex flex-col items-center">
        ...
        <div class="flex flex-row w-3/5 mb-8">
            <div class="h-[65vh] px-8 text-left mr-8">
                <h1 class="text-white text-2xl font-inter block text-center tracking-wide font-thin mb-2 px-8">
                    As introduced, my name is Johny Vu.
                </h1>
                <p class="text-white opacity-80 text-xl font-inter text-left tracking-wide font-thin leading-snug mb-8">
                    I am many things, but for the purpose of this portfolio, I'll keep it short... I am a Frontend Developer
